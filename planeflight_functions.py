...
def load_planeflight_KORUSAQ(rundir):
    ...
    combined_df['PRESS'] = (combined_df['PRESS'] // 50) * 50
...
### Unit conversions
def molec_cm3_to_vv(conc_molec_cm3, P_Pa, T_K, output):
    '''
...
def vv_to_molec_cm3(vv, P_Pa, T_K, input_units):
    '''
    ...
    return (vv / conversion) * n_air_cm3
